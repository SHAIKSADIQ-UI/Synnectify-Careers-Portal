        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-xl overflow-hidden shadow-lg">
            <div className="h-[500px] w-full">
              {/* UPDATED MAP EMBED START */}
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3834.032188695168!2d80.62656807509923!3d16.56846478419902!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a35ef17f516222b%3A0x583445eb79c81cca!2sSynnectify%20Technologies!5e0!3m2!1sen!2sin!4v1730024227001!5m2!1sen!2sin"
                width="100%" 
                height="100%" 
                style={{ border: 0 }}
                allowFullScreen
      ...
      {/* <section className="py-20 bg-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/919494669228?text=Hello! I'm ready to start my project. Can we discuss the details?"
              target="_blank"
