      ...
      <div className="max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-8">
            ...
            <div className="border border-transparent rounded-xl p-6 mb-6 shadow-sm bg-white"
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-orange-400 focus:border-orange-400 transition-colors duration-300 bg-gray-50">
                  <Upload className="mx-auto w-12 h-12 text-gray-400 mb-4" />
                  <label htmlFor="resume" className="block cursor-pointer text-orange-600 font-medium text-lg hover:text-orange-700 focus:text-orange-700 transition-colors duration-300">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-orange-500 to-blue-500 text-white py-4 rounded-xl font-bold text-lg hover:from-orange-600 hover:to-blue-600 focus:from-orange-600 focus:to-blue-600 transition-all duration-300 transform hover:scale-105 focus:scale-105 shadow-lg"
            >
        ...
        <div className="flex justify-center mt-8">
          <button
            ...
            className="inline-flex items-center bg-gradient-to-r from-orange-500 to-blue-500 text-white px-4 py-2 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 focus:scale-105 shadow-md"
          >
